...
const GWL_BUILD_VERSION = "0.9.23 · B04";
...
/* GWL_B04_LIFE_UI_RESTORE */
(function(){
 const s=document.createElement("style");
 s.id="gwl-b04-life-ui-restore";
 s.textContent=`@media (min-width:980px){.main,main.main,.app-main,#main{grid-template-columns:32% 38% 30% !important;}}#organOverlay,.organ-overlay{max-width:100%;box-sizing:border-box;}`;
