...
const expected = new Map([
  ...
  ["global_anthropogenic_erf_1750_2025", ["crossed", 1986, "crossed", 1996]],
  ...
  ["nitrogen_fixation_1961_2022", ["crossed", 1970, "crossed", 1980]],
  ["phosphorus_cropland_1961_2022", ["crossed", 1970, "crossed", 1980]],
...
if (coreCurves.length !== expected.size) throw new Error(`Es werden genau ${expected.size} Kernkurven erwartet.`);
...
console.log(`Grenzstatus gültig: ${expected.size} Kernkurven, Erstüberschreitungen und Sonderfall Ozean 2021/2025 geprüft.`);
