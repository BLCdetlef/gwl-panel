...
if (curveExport.version !== "1.9") throw new Error("Referenzpilot muss Exportversion 1.9 verwenden.");
if (schema.properties?.version?.const !== "1.9") throw new Error("Exportschema muss Version 1.9 verlangen.");
