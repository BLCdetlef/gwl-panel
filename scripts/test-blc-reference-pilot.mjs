...
if (curveExport.version !== "1.7") throw new Error("Referenzpilot muss Exportversion 1.7 verwenden.");
if (schema.properties?.version?.const !== "1.7") throw new Error("Exportschema muss Version 1.7 verlangen.");
