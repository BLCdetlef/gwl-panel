...
if (curveExport.version !== "1.8") throw new Error("Referenzpilot muss Exportversion 1.8 verwenden.");
if (schema.properties?.version?.const !== "1.8") throw new Error("Exportschema muss Version 1.8 verlangen.");
